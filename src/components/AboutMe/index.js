  ...
  return (
    <div id='about-me'>
      ...
      <div id='introduction'>
        ...
        <div id='bio'>
          <p>
            Currently, I work at Nordstrom as a Software Engineer 1 in the Inventory
            Deployment and Planning space! I graduated from The University of Texas 
          ...
          <p>
            ...
            I'm especiallykeen on learning about mobile app development in the future!
          </p>
        </div>
      </div>
    </div>
